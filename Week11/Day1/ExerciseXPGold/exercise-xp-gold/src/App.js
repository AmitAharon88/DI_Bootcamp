...
import BootstarpCard from './components/BootstrapCard';
    ...
    <div className="App">
      {
        celebrities.map((item) => {
          return <BootstarpCard image={item.imageUrl} name={item.title} description={item.description} buttonLabel={item.buttonLabel} buttonUrl={item.buttonUrl} key={item.title}/>
       })
      }
