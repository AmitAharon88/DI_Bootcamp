...
urlpatterns = [
    ...
    path('departments/<int:pk>/', DepartmentRetrieveAPIView.as_view(), name='department-instance'),
    ...
    path('employee/<int:pk>/', EmployeeRetrieveAPIView.as_view(), name='employee-instance'),
