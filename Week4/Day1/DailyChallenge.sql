...
-- INSERT INTO actor(first_name, last_name, birthday, number_oscars)
-- VALUES ('Gomez', 1990-03-23), 1)
-- (It wont let me add another actor with missing data as the fields are required- NOT NULL)
